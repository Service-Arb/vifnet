{
  ...
  outputs = { self, v_flakes }:
    let
      ...
      manifest = (builtins.fromTOML (builtins.readFile ./vifnet/Cargo.toml)).package;
      pname = manifest.name;
    in
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        rs = v_flakes.rs {
          ...
          build = {
            ...
            workspace = let deprecate_by = "v1.0.0"; in {
              "./vifnet/" = [ "git_version" "log_directives" { deprecate = { by_version = deprecate_by; force = true; }; } ];
            };
          };
        };
        github = v_flakes.github {
          ...
          enable = true;
          lastSupportedVersion = "nightly-2026-09-14";
          jobs.default = true;
        };
