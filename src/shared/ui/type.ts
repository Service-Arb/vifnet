...
export const TYPE = {
  ...
  h1: "font-display font-bold text-[48px] leading-[1.02] tracking-[-0.02em] md:text-[72px]",
  ...
  lede: "text-base leading-[1.625] md:text-lg md:leading-[1.625]",
  /** Body/sm relaxed — card and step text, answers: 14. */
  body: "text-sm leading-[1.625]",
